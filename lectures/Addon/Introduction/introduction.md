...
(2) What is AI? (1 sentence)

**Solution**
(1) Intelligence: learn from experience, adapt strategies to context, and solve problems (analyze → generate → evaluate → implement).
(2) AI: studies and develops theories/methods/technologies/systems for simulating, extending, and enhancing intelligence.

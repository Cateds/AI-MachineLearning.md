...
按照这个编码，我们就像在 [Lecture 3](lecture3.md#交叉) 里提到的一样，我们不太可能使用普通的单点交叉进行交叉操作————它可能会破坏排列的性质，导致某些城市被访问多次，而其他城市则未被访问。

![1758463495612](lecture5.assets/1758463495612.png)

所以，这里使用[有序交叉 (Order Crossover, OX)](lecture3.md#交叉)进行对应的交叉操作。
